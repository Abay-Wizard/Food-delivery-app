    ...
    <div className="p-5 max-w-5xl mx-auto">
      ...
      {foodItems.map((item, index) => 
        cartItems[item._id] > 0 && (
          <div
            key={index}
            className="flex flex-col md:grid md:grid-cols-4 gap-4 items-center border rounded-2xl p-4 mb-4 shadow hover:shadow-lg transition"
          >
      ...
      <div className="p-5 max-w-xl mx-auto bg-white rounded-2xl shadow space-y-6 mb-10">
        <h1 className="text-2xl font-bold text-gray-800 text-center">Cart Details</h1>

        {/* Total + Checkout */}
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 border-b pb-4">
          <p className="text-xl font-bold">
            Total: <span className="text-green-600">${Math.round(getTotalCart()) + 2}</span>
          </p>
        ...
        <div className="space-y-3">
          <p className="text-gray-600">If you have a promo code, put it right here:</p>
